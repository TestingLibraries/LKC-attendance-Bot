# LKC-attendance-Bot
Bot that reminds you to mark attendance on telegram when a lesson is available.
...
## Gather your .ics link from elentra
Dashboard --> Bottom right --> Share calendar --> copy.
This is your .ics url!

## Download and edit the code
Gather the Token, ChatID, and ICS URL, and key it into the start of the program.
Save the program.

## Prepare a device that can run the bot 24/7
Download this program on to your device, and simply run the bot!
